...
from model.modules.tfocal_transformer_R import TemporalFocalTransformerBlock, SoftSplit, SoftComp
...
class InpaintGenerator(BaseNetwork):
    ...
    def forward(self, masked_frames, num_local_frames): #No memory of the previous inpaintings, just a block of new frames
        attn_save_0 = torch.Tensor().to(masked_frames.device)
        ...
        trans_feat, attn_save_0, attn_save_1 = self.transformer(trans_feat, attn_save_0, attn_save_1)
        #Nothing after the transformers
        return attn_save_0, attn_save_1 #And we just return the transformers memories
