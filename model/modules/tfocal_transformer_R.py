...
"""
## Just like offline inpainting (block of frames, no memory used)
# But saving the memory of the inpaintings, to be used by the online model later
import math
...
class TemporalFocalTransformerBlock(nn.Module):
    ...
    def forward(self, x, save_tensor_0, save_tensor_1):
        B, T, H, W, C = x.shape
        ...
        return x, save_tensor_0, save_tensor_1
